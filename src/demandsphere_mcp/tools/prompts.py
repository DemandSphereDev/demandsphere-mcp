...
def register(mcp: FastMCP, client: DSClient) -> None:  # noqa: ARG001
    ...
    def weekly_ranking_report(
        ...
        return (
            ...
            "Steps:\n"
            f"1. Call get_keyword_performance with global_key='{site_global_key}', "
    ...
    def competitor_gap(
        ...
        return (
            ...
            "Steps:\n"
            f"1. Call get_keyword_performance for site_global_key='{site_global_key}', "
            f"search_engine='{search_engine}', from_date='{from_date}', to_date='{to_date}'. "
            "Paginate to get all keywords.\n"
            f"2. Call get_keyword_performance for site_global_key='{competitor_global_key}', "
            f"search_engine='{search_engine}', from_date='{from_date}', to_date='{to_date}'. "
            "Paginate to get all keywords.\n"
